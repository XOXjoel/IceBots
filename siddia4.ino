...
int headValue = constrain(headValue, 70, 120);
...
void servoMovement(){
  ...
  if(micros()-last1 > 1000000 && moved){
    ...
    leftArm.write(180); //arm straights
    rightArm.write(70); //arm bends
  }
...
void servoStop(){
  leftLeg.write(80);
  rightLeg.write(0);
  leftArm.write(110); //arm bends
  rightArm.write(70); //arm straights 
}
